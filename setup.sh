...
mamba create -y -n 05_learned_representations python=3.9
mamba activate 05_learned_representations
...
python -m ipykernel install --user --name 05_learned_representations --display-name 05_learned_representations
